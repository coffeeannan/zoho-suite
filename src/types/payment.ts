...
export interface ListPayment
   ...
   * to this payment. We added this, as "invoices" array
   * does not exist for payment list and payments with just one invoice attached
   */
  invoice_numbers_array: string[];

  /**
   * Custom field gateway transaction id - exist only, if you have created that field in Zoho
   */
...
export interface CreatePaymentResInvoice {
  invoice_id: string;
  amount_applied: number;
}
...
export interface CreatePaymentRes {
  ...
  invoices: CreatePaymentResInvoice[];
